...
const PersonalInformation = () => {
  ...
  // Which field is currently being edited: { key, label, value } | null
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-center justify-between border-b border-gray-100 pb-4">
        ...
        <button
          onClick={() =>
            openEditModal("companyName", "Company Name", fields.companyName)
          }
      ...
      <div className="flex items-center justify-between border-b border-gray-100 pb-4">
        ...
        <button
          onClick={() =>
            openEditModal("phone", "Phone Number", fields.phone)
          }
          className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 cursor-pointer"
        >
          <img
      ...
      <div className="flex items-center justify-between border-b border-gray-100 pb-4">
        ...
        <button
          onClick={() =>
            openEditModal("address", "Address", fields.address)
          }
          className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 cursor-pointer"
        >
          <img
      ...
      <div className="flex flex-col gap-4">
        ...
        {!bank ? (
          ...
          <button
            ...
            className="bg-white rounded-[10px] shadow border border-[#CCCCCCB2] p-5 flex flex-col gap-4 cursor-pointer hover:shadow-md transition text-left"
          >
            <div>
          ...
          <div className="bg-white rounded-[10px] shadow border border-[#CCCCCCB2] p-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p
                    className={`${fontSize.xs} ${textColor.secondary} mt-1`}
                  >
                    {bank.accountName}
                  </p>
                </div>
            ...
            <div className="mt-4 pl-11">
              <p
                className={`${fontSize.sm} ${fontWeight.normal} ${textColor.secondary}`}
              >
                Account Number
              </p>
            ...
            {/* <button
              onClick={() => setShowWalletModal(true)}
              className="mt-5 text-sm font-medium text-[#2563EB] hover:underline cursor-pointer"
            >
              Change Bank
            </button> */}
    ...
    <div>
      ...
      <div className="flex justify-center items-center flex-col">
        ...
        <div
          style={{
            background:
              "linear-gradient(135deg, #6B7FD4 0%, #8B9FE8 100%)",
          }}
      ...
      <div className="px-4 mt-8">
        ...
        <p
          className={`${fontSize.lg} ${fontWeight.medium} ${fontFamily.main}`}
        >
          Invite and Earn
        </p>
        ...
        >
          Share your referral invite link with
          friends and receive reward bonuses
          instantly inside your balance wallet
          upon their sign-up verification check!
        </p>
...
const Security = () => {
  // Track whether the user already has a PIN set — adjust this
  // to come from real account data instead of hardcoding.
  const [hasPin, setHasPin] = useState(true);

  // Which modal is open: "password" | "pin" | null
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col items-center gap-2 mt-2">
                ...
                <div className="relative">
                  ...
                  <button
                    className="absolute bottom-1 right-1 bg-white rounded-full p-1 shadow hover:bg-gray-100 transition cursor-pointer"
                  >
                    <img
                      src={EditIcon}
                      alt="edit"
        ...
        <div className="hidden lg:flex gap-6 items-stretch">
          ...
          <div className="flex w-100 shrink-0 bg-white shadow-[100px_100px_100px_100px_rgba(0,0,0,0.1)] rounded-2xl p-5 flex-col items-center gap-6">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span
                className={`${fontSize.md} ${fontWeight.bold} ${textColor.primaryDark} ${fontFamily.main}`}
              >
                James & Co.
              </span>
